...
from ...eps_auth_oauth.controllers.check_token import get_token_from_bearer, AuthOauthCheckToken as Auth
...
#                 checktoken = request.env['auth.oauth.multi.token'].sudo().search(
#                     [('oauth_access_token', '=', access_token),('device_id','=',request.httprequest.headers['device_id'])], order='id DESC')
